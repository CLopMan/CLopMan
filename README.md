...
- 🔭 Working on a [RISCV implementation](https://github.com/CLopMan/JACAA) for fpga usage and a [Creator](https://github.com/creatorsim/creator) ampliation to support RISC-V Vector Extenssion ([check it](https://github.com/CLopMan/creator))
